...
namespace DotnetTraq.Model
{
    ...
    public partial class OAuth2Client : IValidatableObject
    {
        ...
        public OAuth2Client(string id = default(string), string name = default(string), string description = default(string), Guid developerId = default(Guid), List<OAuth2Scope> scopes = default(List<OAuth2Scope>), bool confidential = default(bool))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for OAuth2Client and cannot be null");
            }
            this.Id = id;
            ...
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for OAuth2Client and cannot be null");
            }
