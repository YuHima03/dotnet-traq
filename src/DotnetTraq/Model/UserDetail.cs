...
namespace DotnetTraq.Model
{
    ...
    public partial class UserDetail : IValidatableObject
    {
        ...
        public UserDetail(Guid id = default(Guid), UserAccountState state = default(UserAccountState), bool bot = default(bool), Guid iconFileId = default(Guid), string displayName = default(string), string name = default(string), string twitterId = default(string), DateTimeOffset? lastOnline = default(DateTimeOffset?), DateTimeOffset updatedAt = default(DateTimeOffset), List<UserTag> tags = default(List<UserTag>), List<Guid> groups = default(List<Guid>), string bio = default(string), Guid? homeChannel = default(Guid?))
        {
            this.Id = id;
            this.State = state;
            this.Bot = bot;
            ...
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for UserDetail and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UserDetail and cannot be null");
            }
            this.Name = name;
            // to ensure "twitterId" is required (not null)
            if (twitterId == null)
            {
                throw new ArgumentNullException("twitterId is a required property for UserDetail and cannot be null");
            }
            this.TwitterId = twitterId;
            // to ensure "lastOnline" is required (not null)
            if (lastOnline == null)
            {
                throw new ArgumentNullException("lastOnline is a required property for UserDetail and cannot be null");
            }
            ...
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for UserDetail and cannot be null");
            }
            this.Tags = tags;
            // to ensure "groups" is required (not null)
            if (groups == null)
            {
                throw new ArgumentNullException("groups is a required property for UserDetail and cannot be null");
            }
            this.Groups = groups;
            // to ensure "bio" is required (not null)
            if (bio == null)
            {
                throw new ArgumentNullException("bio is a required property for UserDetail and cannot be null");
            }
            this.Bio = bio;
            // to ensure "homeChannel" is required (not null)
            if (homeChannel == null)
            {
                throw new ArgumentNullException("homeChannel is a required property for UserDetail and cannot be null");
            }
