...
namespace DotnetTraq.Model
{
    ...
    /// チャンネルトピック
    /// </summary>
    [DataContract(Name = "ChannelTopic")]
    public partial class ChannelTopic : IValidatableObject
    {
        ...
        protected ChannelTopic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelTopic" /> class.
        /// </summary>
        /// <param name="topic">トピック (required).</param>
        public ChannelTopic(string topic = default(string))
        {
            // to ensure "topic" is required (not null)
            if (topic == null)
            {
                throw new ArgumentNullException("topic is a required property for ChannelTopic and cannot be null");
            }
            this.Topic = topic;
        }
