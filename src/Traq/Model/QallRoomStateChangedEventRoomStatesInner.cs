...
namespace Traq.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QallRoomStateChangedEvent_roomStates_inner")]
    public partial class QallRoomStateChangedEventRoomStatesInner : IValidatableObject
    {
        ...
        protected QallRoomStateChangedEventRoomStatesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QallRoomStateChangedEventRoomStatesInner" /> class.
        /// </summary>
        /// <param name="roomId">ルームのID (required).</param>
        /// <param name="participants">participants (required).</param>
        /// <param name="isWebinar">ウェビナールームかどうか (required).</param>
        /// <param name="metadata">ルームに関連付けられたカスタム属性.</param>
        public QallRoomStateChangedEventRoomStatesInner(Guid roomId = default(Guid), List<QallRoomStateChangedEventRoomStatesInnerParticipantsInner> participants = default(List<QallRoomStateChangedEventRoomStatesInnerParticipantsInner>), bool isWebinar = default(bool), string metadata = default(string))
        {
            this.RoomId = roomId;
            // to ensure "participants" is required (not null)
            if (participants == null)
            {
                throw new ArgumentNullException("participants is a required property for QallRoomStateChangedEventRoomStatesInner and cannot be null");
            }
        ...
        [DataMember(Name = "isWebinar", IsRequired = true, EmitDefaultValue = true)]
